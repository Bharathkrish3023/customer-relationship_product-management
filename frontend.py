...
page_bg = """
    ...
    [data-testid="stAppViewContainer"] {
        background: url("https://media.licdn.com/dms/image/C4D12AQHkpQfSMOKY0g/article-cover_image-shrink_720_1280/0/1520082855752?e=2147483647&v=beta&t=NCpkrORrhhopFx_IWHWwJYy-eCxZLMYAA1644JJyj5w") no-repeat center center fixed;
...
# Sidebar navigation
st.sidebar.title("Main Nenu")
with st.sidebar:
 page = option_menu(menu_title="Main Menu", options=["Dashboard","Customers", "Products", "Sales", "Summary"], icons=["activity","people", "box", "cash", "bar-chart"], menu_icon="cast", default_index=0, orientation="vertical")

# **Customers Management**
if page == "Dashboard":
    st.title("Welcome to Customer Relationship And Product Mangement System")

    image_path = "C:/Users/BharathKrishna.S/OneDrive/Pictures/Screenshots/Screenshot 2024-12-11 233123.png" 
